...
begin
 ...
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'/',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'-',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'.',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,',',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'\',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'_',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,':',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'+',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'*',DateSeparator);
 DateasDDMMYYYY:=StrReplace(DateasDDMMYYYY,'#',DateSeparator);
 ...
 s:=pos(DateSeparator,DateasDDMMYYYY);
 ...
 if yyyy>0
  then begin
   if yyyy<100
      then begin
        t:=shortdateformat;
        shortdateformat:='m'+DateSeparator+'d'+DateSeparator+'yy';
        Result:=StrToDate(IntToStr(mm)+DateSeparator+IntToSTr(dd)+DateSeparator+IntToSTr(yyyy));
        shortdateformat:=t;
      end
      else try
